function init() {
  ...
  function renderCards(pkmn, i) {
    ...
    document.getElementById("content").innerHTML += overviewHTML(
      i, pokeId, pokeName, backgroundColor1, primaryType, backgroundColor2, secondaryType, pokeImg
    );
  }
  ...
  async function openPkmnCard(i) {
    ...
    document.getElementById("pkmnCard").innerHTML = createCardHTML(
      i, backgroundColor1, backgroundColor2, primaryType, secondaryType, pokeName, pokeId, pokeImg);
